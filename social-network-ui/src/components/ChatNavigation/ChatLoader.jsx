                ...
                {pendingItems.map((_, index) => (
                    <li key={index} className={`${styles.chatNavSection__chatList__items__item} ${styles.pending__item}`}>
                        ...
                        <div className={`${styles.chatNavSection__chatList__items__item} ${styles.pending__item__lines}`}>
                            <div className={`${styles.chatNavSection__chatList__items__item} ${styles.pending__item__lines__line1}`}></div>
                            <div className={`${styles.chatNavSection__chatList__items__item} ${styles.pending__item__lines__line2}`}></div>
                        </div>
                    </li>
                ))}
            </ul>
