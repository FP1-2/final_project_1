...
export default function ChatItem({ chatItemClass, message, photo, name, 
                                    isUnread, isRead, additionalClass, additionalClass2, 
                                    clickHandler, time, showTime }) {

    return (
        <div className={`${styles.chatItemContainer} ${chatItemClass}`} onClick={clickHandler}>
            ...
            <div className={styles.chatItemContainer__infoWrap}>
                <div className={styles.chatItemContainer__info}>
                    ...
                    <div className={styles.chatItemContainer__info__text}>
                        <span className={`${styles.chatItemContainer__info__text__lastMessage} ${isUnread && styles.unread}`}>{message}
                        </span>
                        <span className={`${styles.chatItemContainer__info__text__time} ${!showTime && styles.none}`}>{getTimeAgo(time)}</span>
                    </div>
