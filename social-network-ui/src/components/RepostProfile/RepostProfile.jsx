...
const RepostProfile = () => {
  ...
  return (
    <div className={style.post}>
      ...
      <p className={style.postText}>Щось там</p>
      <div className={style.repostWrapper}>
        <a href="" className={style.repostAvatarLink}>
          <img src="https://risovach.ru/upload/2013/01/mem/kakoy-pacan_9771748_orig_.jpeg" alt="" className={style.repostAvatar} />
        </a>
        <a className={style.repostNameLink} href="">Петро</a>
      </div>
      <p className={style.repostText}>Текст автора</p>
